...
def compare_outputs(t1, t2, t3, field):
    ...
    #print("\n================= OCR COMPARISON =================")
    #print(f"{'':<17} t1':<25} | t2                        | t3")
    #print(f"{'Raw Outputs':<17}: {outputs_final[0]:<25} | t{outputs_final[1]:<25} | t{outputs_final[2]}")
    ...
    valid_outputs = [val for val in outputs_final if val in val != "Not found"]
